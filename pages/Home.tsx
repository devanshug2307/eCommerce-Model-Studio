...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="bg-warm-white text-rich-black min-h-screen">
      <Header />

      {/* Hero Section */}
      <main className="relative overflow-hidden">
        {/* Subtle background accent */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-light/30 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
            <div className="space-y-8">
              <div className="inline-block">
                <span className="inline-flex items-center gap-2 px-4 py-2 bg-teal-light border border-deep-teal/20 rounded-full text-deep-teal text-sm font-medium">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold leading-tight">
              ...
              <div className="flex items-center gap-8 pt-4">
                <div>
                  <div className="text-3xl font-serif font-bold text-rich-black">15K+</div>
                  <div className="text-sm text-gray-500">Images Generated</div>
                </div>
                <div className="w-px h-12 bg-gray-200"></div>
                <div>
                  <div className="text-3xl font-serif font-bold text-rich-black">800+</div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden border-2 border-gray-200 shadow-lg transform hover:scale-[1.02] transition-transform duration-500">
                <img
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <div className="aspect-[3/4] relative group">
                ...
                <div className="relative h-full border border-gray-200 rounded-2xl overflow-hidden shadow-2xl">
                  <BeforeAfterSlider
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="text-center p-6 rounded-xl bg-gray-900/40 border border-gray-200 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="relative group">
                  ...
                  <div className="relative p-8 rounded-2xl border border-gray-200 bg-white hover:border-gray-600 transition-all duration-300">
          ...
          <section className="mb-16 sm:mb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                <div key={idx} className="p-4 sm:p-6 rounded-xl border border-gray-200 bg-white hover:border-gray-600 transition-all duration-300 text-center">
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="group p-6 rounded-xl border border-gray-200 bg-white hover:border-gray-600 transition-all duration-300 hover:-translate-y-1"
                >
          ...
          <section className="text-center py-16 sm:py-24 relative px-4">
            <div className="absolute inset-0 bg-soft-cream rounded-3xl blur-3xl"></div>
            <div className="relative">
